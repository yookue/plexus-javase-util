...
public abstract class FileExtensionConst {
    public static final String CLASS = ".class";    // $NON-NLS-1$
    public static final String CSS = ".css";    // $NON-NLS-1$
    ...
    public static final String HTM = ".htm";    // $NON-NLS-1$
    ...
    public static final String JSP = ".jsp";    // $NON-NLS-1$
    public static final String LOG = ".log";    // $NON-NLS-1$
    public static final String PDF = ".pdf";    // $NON-NLS-1$
    public static final String PNG = ".png";    // $NON-NLS-1$
    public static final String PPT = ".ppt";    // $NON-NLS-1$
    public static final String PPTX = ".pptx";    // $NON-NLS-1$
